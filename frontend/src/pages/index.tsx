          ...
          <section className=' container'>
            <div className='about-section'>
              <div className='about-wrapper mt-5 '>
                <div className='left'>
                  {/* <p className=" fs-1 josefin fw-400 fs-36 text-capitalize">
									<span className=" fw-700 fs-36 text-capitalize josefin fs-1">
										about &nbsp;
									</span>
									brighter <br /> dawn
								</p> */}
          ...
          <section className='overview mt-5'>
            <div className='overview-sect container'>
              <div className='overview-wrapper'>
                ...
                {/* <div className='overview-sect-right'>
                  <p className='josefin fw-400 fs-36 text-capitalize'>
                    why choose us
                  </p>
                  <p className=' fw-light fs-18 lh-2'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Voluptate exercitationem iusto nisi fugit, ea placeat quae
                    rerum tenetur cupiditate labore earum expedita sint non esse
                    recusandae nemo id? Perspiciatis, sunt.
                  </p>
                  <div className='numbers'>
                    <div className='numbers-left'>
                      <p className='fw-700 fs-40 p1'>
                        74k<sup>+</sup>
                      </p>
                      <p className=' text-capitalize'>qualified teachers</p>
                    </div>
                    <div>
                      <p className='fw-700 fs-40 p1'>250</p>
                      <p className=' text-capitalize'>extra curricular</p>
                    </div>
                  </div>
                </div> */}
                  ...
                  <div className='text-content'>
                    ...
                    <div className='numbers'>
                      <div className='number-74k'>
                        ...
                        <p className='fw-light fs-18 word'>Qualified Teachers </p>
                      </div>
                ...
                return (
                  <div className='news-sect-item-desc' key={id}>
                    ...
                    <p className='fs-14 fw-700 lh-2 mt-4'>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                      sed do eiusmod tempor incididunt ut n ullamco laboris nisi
                      ut .
                    </p>
